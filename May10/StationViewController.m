...
//Called when the user presses the StationView's "More Info" button.
//Create an InfoController and display it modally.
...
- (void) loadView
{
	...
	self.view = [[StationView alloc] initWithFrame: frame controller: self];
}
